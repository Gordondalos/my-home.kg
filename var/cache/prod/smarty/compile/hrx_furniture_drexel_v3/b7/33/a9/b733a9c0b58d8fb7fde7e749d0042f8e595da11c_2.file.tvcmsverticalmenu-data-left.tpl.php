...
/* Smarty version 3.1.43, created on 2022-05-29 02:53:32
  from '/var/www/html/modules/tvcmsverticalmenu/views/templates/hook/tvcmsverticalmenu-data-left.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.43',
  'unifunc' => 'content_62928bccee0485_95122530',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b733a9c0b58d8fb7fde7e749d0042f8e595da11c' => 
    array (
      0 => '/var/www/html/modules/tvcmsverticalmenu/views/templates/hook/tvcmsverticalmenu-data-left.tpl',
      1 => 1653771104,
      2 => 'file',
    ),
  ),
...
function content_62928bccee0485_95122530 (Smarty_Internal_Template $_smarty_tpl) {
?>    <?php if ($_smarty_tpl->tpl_vars['page']->value['page_name'] == 'index') {?><div class="tvcmsvertical-menu-wrapper-data wow fadeInUp"><div class="tvcmsvertical-menu-wrapper"><div id='tvcmsdesktop-vertical-menu'><div class='tvcmsverticalmenu'><div id="tvverticalmenu" class="tvcmsvertical-menu"><ul class="menu-content tvverticalmenu-dropdown tv-dropdown tvleft-right-penal-all-block"><?php
...
"><img class="img-responsive lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="<?php echo htmlspecialchars(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['link_rewrite'],$_smarty_tpl->tpl_vars['product']->value['id_image'],'home_default'),'htmlall','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
...
echo htmlspecialchars(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['product']->value['name'],'htmlall','UTF-8' )), ENT_QUOTES, 'UTF-8');
}?>" /></a><?php if ((isset($_smarty_tpl->tpl_vars['product']->value['on_sale'])) && $_smarty_tpl->tpl_vars['product']->value['on_sale'] && (isset($_smarty_tpl->tpl_vars['product']->value['show_price'])) && $_smarty_tpl->tpl_vars['product']->value['show_price'] && !$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {
