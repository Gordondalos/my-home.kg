...
* @author PrestaShop SA <contact@prestashop.com>
    ...
    *}
    ...
    <div class="tvleft-penal-product-top clearfix">
        <div id="js-product-list-top" class="products-selection tvcenter-block-product-section tvall-block-box-shadows clearfix wow fadeInUp">
        ...
        {hook h='displayFacetedSearch' show_data_filter="true"}
        {/if}
        {* End Faceted Search *}
    </div>
    {/strip}