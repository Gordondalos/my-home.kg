    ...
    <div class="tvproduct-wrapper {$class_name}">
        ...
        <div class="tvproduct-image">
            ...
            <a href="{$product.url}" class="thumbnail product-thumbnail" itemprop="url">
                <img src="{$product.cover.bySize[$image_size]['url']}" alt="{if !empty($product.cover.legend)}{$product.cover.legend}{else}{$product.name}{/if}" class="tvproduct-defult-img " height="{$product.cover.bySize[$image_size]['height']}" width="{$product.cover.bySize[$image_size]['width']}" itemprop="image">
                ...
                <img class="tvproduct-hover-img " src="{$product.images.0.bySize[$image_size]['url']}" alt="{$product.name}" height="{$product.images.0.bySize[$image_size]['height']}" width="{$product.images.0.bySize[$image_size]['width']}" itemprop="image">
                {elseif isset($product.images.1.bySize[$image_size]['url']) && empty($product.images.1.cover)}
                <img class="tvproduct-hover-img" src="{$product.images.1.bySize[$image_size]['url']}" alt="{$product.name}" height="{$product.images.1.bySize[$image_size]['height']}" width="{$product.images.1.bySize[$image_size]['width']}" itemprop="image">
                {/if}
                {/if}
            </a>
            {else}
            <a href="{$product.url}" class="thumbnail product-thumbnail">
                <img src="{$urls.no_picture_image.bySize[$image_size]['url']}" height="{$urls.no_picture_image.bySize[$image_size]['height']}" width="{$urls.no_picture_image.bySize[$image_size]['width']}" itemprop="image">
            </a>
            {/if}
