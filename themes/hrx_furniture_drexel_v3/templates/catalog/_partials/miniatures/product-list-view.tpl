    ...
    <div class="tvproduct-wrapper list">
        ...
        <div class="tvproduct-image col-sm-4">
            ...
            <a href="{$product.url}" class="thumbnail product-thumbnail">
                ...
                <img class="tvproduct-hover-img" src="{$product.images.1.bySize[$image_size]['url']}" alt="{$product.name}" height="{$product.images.0.bySize[$image_size]['height']}" width="{$product.images.0.bySize[$image_size]['width']}">
                {/if}
                {/if}
            </a>
            {else}
