    ...
    *}
    ...
    <div id="main" itemscope itemtype="https://schema.org/Product">
        ...
        <div class="tvproduct-page-wrapper ">
            <div class="tvprduct-image-info-wrapper clearfix row wow fadeInUp">
                ...
                <div class="col-md-6 tv-product-page-content">
                    <div class="tvproduct-title-brandimage" itemprop="itemReviewed" itemscope itemtype="http://schema.org/Thing">
                        ...
                        <a href="{$product_brand_url}" class="tvproduct-brand">
                            <img src="{$manufacturer_image_url}" alt="{$product_manufacturer->name}" title="{$product_manufacturer->name}">
                        </a>
                        {/if}
                        </div>
                    </div>
            ...
            <div class="tabs tvproduct-description-tab wow fadeInUp">
        ...
        {if $accessories}
        <div class="tvcmslike-product container-fluid wow fadeInUp">
