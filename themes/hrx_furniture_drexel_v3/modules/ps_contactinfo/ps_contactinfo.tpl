 ...
 *}
{strip}
<div class="{* tvfooter-logo-link-wrapper *}links col-xl-3 col-lg-3 col-md-12 wow fadeInUp">
   ...
   <div class="tvfooter-title-wrapper" data-target="#footer_sub_menu_store_info" data-toggle="collapse">
    ...
    <div id="footer_sub_menu_store_info" class="collapse">
      <div class="tvfooter-addresses">
          ...
          {$contact_infos.address.address1 nofilter}<br>
          {$contact_infos.address.address2 nofilter}
      </div>
      
          {if $contact_infos.email}
            <div class="tvfooter-store-link">{* [1][/1] is for a HTML tag. 
              *}{l
              s='[1]%email%[/1]'
              sprintf=[
