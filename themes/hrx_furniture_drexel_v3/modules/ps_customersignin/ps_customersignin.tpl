 ...
 *}
{strip}
<div id="tvcmsdesktop-user-info" class="tvcms-header-sign">
  <div class="user-info tvheader-sign">
    ...
    {else}
      <a href="{$my_account_url}" class="tvhedaer-sign-btn" title="{l s='Log in to your customer account' d='Shop.Theme.Customeraccount'}" rel="nofollow"
      >
