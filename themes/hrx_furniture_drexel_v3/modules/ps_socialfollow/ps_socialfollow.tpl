...
* @author PrestaShop SA <contact@prestashop.com>
   ...
   <div class="block-social tvcmsfooter-social-icon col-xl-6 col-md-6 col-sm-12 wow fadeInUp">
            ...
            *}{if !empty(Configuration::get('BLOCKSOCIAL_FACEBOOK'))}
            <li class="facebook">
                <a href="{Configuration::get('BLOCKSOCIAL_FACEBOOK')}" target="_blank">
                    <span class="facebook-icon"></span>{*<span class="tvsocial-title">{l s='Facebook' d='Shop.Theme.Catalog'}</span>*}
                    <svg class="tvblock-social-icon" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="facebook-f" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
            ...
            <li class="twitter">
                <a href="{Configuration::get('BLOCKSOCIAL_TWITTER')}" target="_blank">
                    <span class="twitter-icon"></span>{*<span class="tvsocial-title">{l s='Twitter' d='Shop.Theme.Catalog'}</span>*}
                    <svg class="tvblock-social-icon" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="twitter" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            ...
            <li class="youtube">
                <a href="{Configuration::get('BLOCKSOCIAL_YOUTUBE')}" target="_blank"><span class="youtube-icon"></span>{*<span class="tvsocial-title">{l s='Youtube' d='Shop.Theme.Catalog'}</span>*}
                    <svg class="tvblock-social-icon" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="youtube" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
            ...
            <li class="googleplus">
                <a href="{Configuration::get('BLOCKSOCIAL_GOOGLE_PLUS')}" target="_blank">
                    ...
                    <svg class="tvblock-social-icon" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="google-plus-g" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
            ...
            <li class="instagram">
                <a href="{Configuration::get('BLOCKSOCIAL_INSTAGRAM')}" target="_blank">
                    <span class="instagram-icon"></span>{*<span class="tvsocial-title">{l s='Instagram' d='Shop.Theme.Catalog'}</span>*}
                    <svg class="tvblock-social-icon" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="instagram" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
