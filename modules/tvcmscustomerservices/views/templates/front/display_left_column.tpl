...
{if $dis_arr_result.status && $getSTATUS == 0}
                                            ...
                                            <div class="tvservices-wrapper">
                                                <div class="tvservices-img-conut">
                                                    <div class='tvservices-img'> 
                                                        {* <i class='material-icons'>&#xe163;</i>  *}
                                                        <img src="{$dis_arr_result.path}{$dis_arr_result.data.service_1.image}">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="tvservices-2 tvall-services-block">
                                                <div class="tvservices-wrapper">
                                                    <div class="tvservices-img-conut">
                                                        <div class='tvservices-img'>
                                                            {* <i class='material-icons'>&#xe32a;</i> *} 
                                                            <img src="{$dis_arr_result.path}{$dis_arr_result.data.service_2.image}">
                                                        </div>
                                                    </div>
                                                    <div class='tvservices-content-box'>
                                                        <div class="tvservices-info">
                                        ...
                                        <div class="tvservices-3 tvall-services-block">
                                            <div class="tvservices-wrapper">
                                                <div class="tvservices-img-conut">
                                                    <div class='tvservices-img'>
                                                        {* <i class='material-icons'>&#xe8f6;</i> *}
                                                        <img src="{$dis_arr_result.path}{$dis_arr_result.data.service_3.image}">
                                                    </div>
                                                </div>
                                                <div class='tvservices-content-box'>
                                                    <div class="tvservices-info">
