...
class TvcmsCustomerServices extends Module
{
    public function __construct()
    {
        ...
        $this->displayName = $this->l('HRXTemplate - Customer Services');
    ...
    public function postProcess()
    {
        ...
        if (Tools::isSubmit('submitTvcmsCustomerServicesForm')) {
        ...
        if (Tools::isSubmit('submittvcmsCustomerServicesMainTitleForm')) {
            $languages = Language::getLanguages();
            $obj_image = new TvcmsCustomerServicesImageUpload();
            foreach ($languages as $lang) {
    ...
    public function showFrontData()
    {
        ...
        $result['service_1']['status'] = Configuration::get('TVCMSCUSTOMERSERVICES_SERVICES_1_STATUS');
        ...
        $result['service_2']['status'] = Configuration::get('TVCMSCUSTOMERSERVICES_SERVICES_2_STATUS');
        ...
        $result['service_3']['status'] = Configuration::get('TVCMSCUSTOMERSERVICES_SERVICES_3_STATUS');
        ...
        $result['service_4']['status'] = Configuration::get('TVCMSCUSTOMERSERVICES_SERVICES_4_STATUS');
        ...
        $result['service_5']['status'] = Configuration::get('TVCMSCUSTOMERSERVICES_SERVICES_5_STATUS');
