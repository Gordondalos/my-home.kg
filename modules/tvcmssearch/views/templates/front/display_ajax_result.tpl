...
{strip}
 <div class="tvcmssearch-dropdown">
    <div class="tvsearch-dropdown-close-wrapper">
        <div class="tvsearch-dropdown-close"><i class="material-icons">&#xe5cd;</i></div>
    </div>
    ...
    <div class="tvsearch-more-search-wrapper">
    	<div class="tvsearch-more-search tvall-inner-btn"><span>{l s='More Result' mod='tvcmssearch'}</span></div>
    </div>
</div>
{/strip}