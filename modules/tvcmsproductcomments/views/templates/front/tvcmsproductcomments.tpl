...
* @author PrestaShop SA <contact@prestashop.com>
    ...
    *}
    ...
    <div class="tab-pane fade in" id="tvcmsproductCommentsBlock" role="tabpanel">
                    ...
                    <div class="comment clearfix">
                        <div class="comment_author">
                            ...
                            <div class="star_content clearfix">
                                ...
                                <div class="star"><img src="{$path}star-no.png"></div>
                                {else}
                                <div class="star star_on"><img src="{$path}star.png"></div>
                                {/if}
                                {/section}
                            </div>
                        </div>
            ...
            <div id="new_comment_form">
                <form id="id_new_comment_form" action="#">
                    ...
                    <div class="tvcmsproduct-image-comment col-xs-12 col-sm-6 text-center">
                        <img src="{$product.cover.bySize.large_default.url}" alt="{$product->name}" width="300">
                    </div>
