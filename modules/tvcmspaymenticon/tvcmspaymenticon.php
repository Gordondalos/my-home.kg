...
class TvcmsPaymentIcon extends Module
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->l('HRXTemplate - Payment Icon');
    ...
    public function createVariable()
    {
        ...
        foreach ($languages as $lang) {
            ...
            $result['TVCMSPAYMENTICON_IMG'][$lang['id_lang']] = 'demo_main_img_1.png';
        }
    ...
    public function postProcess()
    {
        ...
        if (Tools::isSubmit('submittvcmsPaymentIconForm')) {
            $old_file = '';
        ...
        if (Tools::isSubmit('submittvcmsPaymentIconMainTitleForm')) {
            $languages = Language::getLanguages();
            $obj_image = new TvcmsPaymentIconImageUpload();
            foreach ($languages as $lang) {
