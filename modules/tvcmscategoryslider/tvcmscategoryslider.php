...
class TvcmsCategorySlider extends Module
{
    ...
    public function __construct()
    {
        ...
        parent::__construct();
        $this->displayName = $this->l('HRXTemplate - Categroy Slider');
    ...
    public function createVariable()
    {
        ...
        foreach ($languages as $lang) {
            ...
            $result['TVCMSCATEGORY_SLIDER_BUTTON'][$lang['id_lang']] = 'Explore All';
        ...
        $tmp = $result['TVCMSCATEGORY_SLIDER_BUTTON'];
        Configuration::updateValue('TVCMSCATEGORY_SLIDER_BUTTON', $tmp);
    ...
    public function insertSmapleData($num_of_data)
    {
        ...
        for ($i=1; $i<=$num_of_data; $i++) {
            if (isset($category[$i]['id_category'])) {
                ...
                $imagedata = getimagesize(_PS_BASE_URL_.$ImageSizePath.'Category-Icons-'.$i.'.png');
                $width = $imagedata[0];
                $height = $imagedata[1];
    ...
    public function showFrontData()
    {
        ...
        if (!empty($result)) {
            foreach ($result as $key => $r) {
                $r['prod_count'] = $this->countProductInCat($r['id_category']);
                $result_data[$key] = $r;
            }
        }
        return $result_data;
    ...
    public function deleteVariable()
    {
        ...
        Configuration::deleteByName('TVCMSCATEGORY_SLIDER_BUTTON');
    ...
    public function removeImage($id)
    {
        ...
        foreach ($remove_images as $image) {
            ...
            $res = preg_match('/^Category-Icons-.*$/', $image);
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('submitTvcmsCategoryTitle')) {
            foreach ($languages as $lang) {
                ...
                $tmp = Tools::getValue('TVCMSCATEGORY_SLIDER_BUTTON_'.$lang['id_lang']);
                $result['TVCMSCATEGORY_SLIDER_BUTTON'][$lang['id_lang']] = $tmp;
    ...
    public function getConfigFormValues()
    {
        ...
        foreach ($languages as $lang) {
            ...
            $a = Configuration::get('TVCMSCATEGORY_SLIDER_BUTTON', $lang['id_lang']);
            $fields['TVCMSCATEGORY_SLIDER_BUTTON'][$lang['id_lang']] = $a;
    ...
    protected function tvcmsCategoryTitle()
    {
        ...
        if ($show_fields['btn_caption']) {
            $input[] = array(
                        'col' => 7,
                        'type' => 'text',
                        'name' => 'TVCMSCATEGORY_SLIDER_BUTTON',
                        'label' => $this->l('Category Banner Button Caption'),
                        'lang' => true,
                    );
        }
    ...
    public function showFrontSideResult()
    {
        ...
        if ($main_heading['main_status']) {
            ...
            $main_heading_data['button'] = Configuration::get('TVCMSCATEGORY_SLIDER_BUTTON', $id_lang);
