...
* @author PrestaShop SA <contact@prestashop.com>
    ...
    *}
    ...
    <div class='tvcmscategory-chain-slider container-fluid bottom-to-top hb-animate-element wow fadeInUp'>
        <div class='tvcategory-chain-slider container'>
            ...
            <div class="tvcategory-chain-slider-inner-info-box">
                        ...
                        <div class="tvcategory-chain-slider-wrapper clearfix">
                            <div class="tvcategory-chain-slider-info-wrapper">
                                <div class="tvcategory-chin-img-block col-xl-12 col-lg-12 col-md-12 col-xs-12">
                                    <img src="{$dis_arr_result['path']}{$data['image']}" alt="{$data['title']}" width="{$data['width']}" height="{$data['height']}" />
                                ...
                                <div class="tvcategory-chain-content-wrapper col-xl-12 col-lg-12 col-md-12 col-xs-12">
                                    ...
                                    {if $count <= 3} <a href="{$link->getCategoryLink($cat_info['id_category'])}" title="{$cat_info['name']}" class="tvcategory-chain-slider-category">
                                        {$cat_info['name']}
                                        </a>
                                        {$count = $count + 1}
                                        {else}
                                        ...
                                        <span class="tvcategory-chain-slider-all-link">
                                            <button class="tvall-inner-btn">
                                                <a href="{$link->getCategoryLink($data['id_category'])}" title="{$data['title']}">
                                                    ...
                                                    <span>{l s='View All' mod='tvcmscategorychainslider'}</span>
                                                </a>
                                            </button>
                                        </span>
                                        {/if}
                ...
                <div class='tvcategory-chain-slider-pagination-wrapper tv-pagination-wrapper'>
                    <div class="tvcategory-chain-slider-pagination">
