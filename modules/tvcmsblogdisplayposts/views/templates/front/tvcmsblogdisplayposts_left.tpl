...
* @author PrestaShop SA <contact@prestashop.com>
    ...
    *}
    {strip}
    {if isset($status_blog_all) && $dis_arr_result['status'] && $status_blog_all == 1}
    <div class="tvcmsblog-event tvcmsblog-left-side wow fadeInUp">
                ...
                <div class="tvnews-event-wrapper tvall-block-box-shadows">
                    ...
                    <div class="tvblog-event-all-block">
                        <div class="tvblog-event-inner-block">
                            <div class="tvnews-wrapper-info-box owl-carousel owl-theme">
                                {$tmp = 1}
                                                ...
                                                <a href="{$tvcmsblgpst.link}" class="img_content">
                                                    <div class="tvnews-event-hoverbtn">
                                                        <div class="tvblog-content-img">
                                                            <picture>
                                                                <source srcset="{$tvcmsblgpst.post_img_small_res}" media="(max-width: 768px)">
                                                                <img src="{$tvcmsblgpst.post_img_small}" alt="{$tvcmsblgpst.post_title}">
                                                            </picture>
                                                        </div>
                                                        ...
                                                        <div class="date_time tvdate-time">{* <span class="tvdate-time-icon"></span> *}{$tvcmsblgpst.post_date|date_format:'<p class="day_time tvday-time"><span>%d</span></p>
                                                            <p class="tvmonth-time"><span>%b</span></p>' nofilter}{* ,<p class="tvyear-time"><span>%Y</span></p> *}
                                                        </div>
                                                    </div>
    ...
    {else if isset($status_blog_all) && $dis_arr_result['status'] && $status_blog_all == 0 && $page.page_name == 'index'}
                ...
                <div class="tvnews-event-wrapper tvall-block-box-shadows">
                    ...
                    <div class="tvblog-event-all-block">
                        <div class="tvnews-wrapper-info-box owl-carousel owl-theme">
                            ...
                            {if $dis_arr_result['status']}
                            {foreach from=$dis_arr_result['data'] item=tvcmsblgpst}
                            <article class="blog_pos clearfix tvblog-event-all-content-block">
                                <div class="blog_post_content_top tvblog-img-block col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="post_thumbnail">
                                        {if $tvcmsblgpst.post_format == 'video'}
                                        {assign var="postvideos" value=','|explode:$tvcmsblgpst.video}
                                        ...
                                        <a href="{$tvcmsblgpst.link}" class="img_content">
                                            <div class="tvnews-event-hoverbtn">
                                                ...
                                                <div class="date_time tvdate-time">{* <span class="tvdate-time-icon"></span> *}{$tvcmsblgpst.post_date|date_format:'<p class="day_time tvday-time"><span>%d</span></p><p class="tvmonth-time"><span>%b</span></p>' nofilter}{* ,<p class="tvyear-time"><span>%Y</span></p> *}
                                                </div>
                                            </div>
                                        </a>{*<div class="blog_mask">
                                            <div class="blog_mask_content">
                        ...
                        {* <div class='tvcms-blog-left-side-pagination-wrapper tvcms-blog-left-side-pagination'>
                            <div class="tvcms-blog-left-side-next-pre-btn">
                                <div class="tvblog-left-side-prev tvcmsprev-btn"><i class='material-icons'>&#xe314;</i></div>
                                <div class="tvblog-left-side-next tvcmsnext-btn"><i class='material-icons'>&#xe315;</i></div>
                            </div>
