        ...
        <form method="post" class="wl_send unvisible" onsubmit="return (false);">
            ...
            <fieldset>
                <div class="required form-group">
                    <label class="col-xs-12 col-md-3 col-lg-3 tvwishlist-vuew-label" for="email1">{l s='Email' mod='tvcmswishlist'}1 <sup>*</sup></label>
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-md-3 col-lg-3 tvwishlist-vuew-label" for="email{$smarty.section.i.index|escape:'htmlall':'UTF-8'}">{l s='Email' mod='tvcmswishlist'}{$smarty.section.i.index|escape:'htmlall':'UTF-8'}</label>
                    <div class="col-xs-12 col-md-9 col-lg-9">
                ...
                {/section}
                <div class="col-xs-12 col-md-0 col-lg-3 tvwishlist-inner-page-send"></div>
                <p class="required col-xs-6 col-md-6 col-lg-3 tvwishlist-required">
                    <sup>*</sup> {l s='Required field' mod='tvcmswishlist'}
                </p>
                <div class="submit col-xs-6 col-md-6 col-lg-6 tvwishlist-send-mess-btn">
