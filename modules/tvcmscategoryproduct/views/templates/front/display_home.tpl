...
* @author PrestaShop SA <contact@prestashop.com>
    ...
    *}
    ...
    <div class='container-fluid tvcmstabcategory-product-slider wow fadeInUp'>
        <div class='container tvtabcategory-product-slider'>
            ...
            <div class='tvtabcategory-all-tab tvtabcategory-product-desktop-view'>
                ...
                <div class="tvtabcategory-product-sub-title-block">
                    <ul class="tvtabcategory-product-inner">
                        ...
                        <li class="tvtabcategory-product-li">
                            ...
                            <a class="tvtabcategory-tab-sub-title" title='{$data["title"]}' data-category-id='{$data["id_category"]}' data-num-prod='{$data["num_of_prod"]}'>{$data['title']}</a>{*
                        ...
                        <li class='tvtabcategory-show show-hide hide'>
                            <a class="tvtabcategory-tab-sub-title">{l s='Show Category' mod='tvcmscategoryproduct'}</a>
                            <i class='material-icons'>&#xe313;</i>
                        </li>
                        <li class='tvtabcategory-hide show-hide hide'>
                            <a class="tvtabcategory-tab-sub-title">{l s='Hide Category' mod='tvcmscategoryproduct'}</a>
                            <i class='material-icons'>&#xe316;</i>
                        </li>
                    </ul>
                </div>
            ...
            <div class='tvtabcategory-tab-product'>
                <div class='tvtabcategory-all-product'>{*
