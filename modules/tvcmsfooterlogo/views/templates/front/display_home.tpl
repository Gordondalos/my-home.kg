...
{if Configuration::get('TVCMSFOOTERLOGO_IMG')}
    ...
    <div class='tvfooter-about-logo-wrapper'>
        <div class='tvfooter-logo-block wow fadeInUp'>
            {if $show_fields['main_image']}
            <div class='tvfooter-img-block'>
                <img src="{$path}{Configuration::get('TVCMSFOOTERLOGO_IMG')}" alt="" height="51" width="205"/>
            </div>
            {/if}
