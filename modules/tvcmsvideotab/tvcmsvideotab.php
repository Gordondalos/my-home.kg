...
class TvcmsVideoTab extends Module
{
    public function __construct()
    {
        ...
        $this->bootstrap = true;
        $this->module_key = '';
        $this->displayName = $this->l('Product Video Tab');
        $this->description = $this->l('Display Video On Product Page');
        parent::__construct();
    }
    ...
    public function installTab()
    {
        ...
        $tab->name = array();
        foreach (Language::getLanguages() as $lang) {
            $tab->name[$lang['id_lang']] = "Product Video Tab";
        }
    ...
    public function hookdisplayAdminProductsExtra($params)
    {
        ...
        $url1  = $this->context->controller->php_self;
        ...
        if ($this->context->cookie->__get('editfrommodule') == 1) {
            $this->context->smarty->assign('editfrommodule', $this->context->cookie->__get('editfrommodule'));
            // Context::getContext()->cookie->__set('editfrommodule') = ;
            $this->context->cookie->__set('editfrommodule', 0);
        } else {
            $this->context->cookie->__set('type', 0);
        }
        if (Tools::version_compare(_PS_VERSION_, '1.7', '>=')) {
    ...
    public function getListContentVideo($helper)
    {
        ...
        if (Tools::getValue($helper->list_id . "Orderby")!='') {
            $this->context->cookie->__set($helper->list_id.'Orderby', Tools::getValue($helper->list_id . "Orderby"));
        }
        if (empty($this->context->cookie->__get($helper->list_id.'Orderby'))) {
            $this->context->cookie->__set($helper->list_id.'Orderby', 'id_video');
        }
        if (Tools::getValue($helper->list_id . "Orderway")!='') {
            $this->context->cookie->__set($helper->list_id.'Orderway', Tools::getValue($helper->list_id . "Orderway"));
        }
        if (empty($this->context->cookie->__get($helper->list_id.'Orderway'))) {
            $this->context->cookie->__set($helper->list_id.'Orderway', 'asc');
        }
        $orderby = $this->context->cookie->__get($helper->list_id.'Orderby');
        $orderway = $this->context->cookie->__get($helper->list_id.'Orderway');
        $helper->orderBy = $orderby;
        $helper->orderWay = Tools::strtoupper($orderway);
        //pagination
        $cookiePagination = $this->context->cookie->__get($helper->list_id.'_pagination');
        ...
        $this->context->cookie->__set($helper->list_id.'_pagination', $selected_pagination);
    ...
    public function setWhereClause($helper)
    {
        ...
        if (Tools::getValue($helper->list_id."Filter_id_video", null) !== null) {
            ...
            $this->context->cookie->__set($helper->list_id.'Filter_id_video', $sql_id_video);
        }
        ...
        if (Tools::getValue($helper->list_id."Filter_id_product", null) !== null) {
            ...
            $this->context->cookie->__set($helper->list_id.'Filter_id_product', $sql_id_product);
        }
        ...
        if (Tools::getValue($helper->list_id."Filter_id_store", null) !== null) {
            ...
            $this->context->cookie->__set($helper->list_id.'Filter_id_store', $sql_id_store);
        }
        ...
        if (Tools::getValue($helper->list_id."Filter_name_product", null) !== null) {
            ...
            $this->context->cookie->__set($helper->list_id.'Filter_name_product', $sql_name_product);
        }
        ...
        if (Tools::getValue($helper->list_id."Filter_shop", null) !== null) {
            ...
            $this->context->cookie->__set($helper->list_id.'Filter_shop', $sql_name_shop);
        }
        ...
        if (Tools::getValue($helper->list_id."Filter_text_url", null) !== null) {
            ...
            $this->context->cookie->__set($helper->list_id.'Filter_text_url', $sql_text_url);
        }
        ...
        if (Tools::getValue($helper->list_id."Filter_language", null) !== null) {
            ...
            $this->context->cookie->__set($helper->list_id.'Filter_language', $sql_language);
        }
        ...
        if (Tools::getValue($helper->list_id."Filter_type", null) !== null) {
            ...
            $this->context->cookie->__set($helper->list_id.'Filter_type', $sql_type);
        }
        if (isset($sql_type)) {
    ...
    public function resetVideo()
    {
        ...
        foreach ($search_field as $v) {
            $this->context->cookie->__set('tvcmsvideotaburl_videoFilter_'.$v, null);
        }
        return true;
    }
    ...
    public function caseVideo()
    {
        ...
        if (Tools::isSubmit('submitResettvcmsvideotaburl_video')) {
            ...
            $this->context->cookie->__set('editfrommodule', 1);
