			...
			{foreach from=$languages item=language}
				...
				{/if}
					<div class="col-lg-6">
						...
						<p>{l s='Image Size (1920 X 850)' mod='tvcmsslider'}</p>
					</div>
				{if $languages|count > 1}
					<div class="col-lg-2">
        ...
        <div class="col-lg-9">
            {foreach from=$languages item=language}
                ...
                {/if}
                    ...
                    <div class="col-lg-6">
                        <div class="dummyfile input-group">
                            <input type="radio" name="{$input.name|escape:'htmlall':'UTF-8'}_{$language.id_lang|escape:'htmlall':'UTF-8'}" value="tvmain-slider-contant-left" {if $name == 'tvmain-slider-contant-left'} checked {/if}/> Left <br>

                            <input type="radio" name="{$input.name|escape:'htmlall':'UTF-8'}_{$language.id_lang|escape:'htmlall':'UTF-8'}" value="tvmain-slider-contant-center" {if $name == 'tvmain-slider-contant-center'} checked {/if}/> Center <br>

                            <input type="radio" name="{$input.name|escape:'htmlall':'UTF-8'}_{$language.id_lang|escape:'htmlall':'UTF-8'}" value='tvmain-slider-contant-right' {if $name == 'tvmain-slider-contant-right'} checked {/if}/> Right <br>

                            <input type="radio" name="{$input.name|escape:'htmlall':'UTF-8'}_{$language.id_lang|escape:'htmlall':'UTF-8'}" value="tvmain-slider-contant-none" {if $name == 'tvmain-slider-contant-none'} checked {/if}/> Hide All Text
