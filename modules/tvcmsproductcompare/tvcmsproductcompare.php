...
class TvcmsProductCompare extends Module
{
    public function __construct()
    {
        ...
        $this->displayName = $this->l('HRXTemplate - Product Compare');
    ...
    public function getAllCompareProduct()
    {
        ...
        if ($context->cookie->__get('tvcmscompare_product_1') != '') {
            ...
            $price_tax_incl = Product::getPriceStatic($context->cookie->__get('tvcmscompare_product_1'), true, null, 3, null, false, true, 1, false, null, null, null, $specific_price_output, true, true, null, true);
            $prod_info_1['price_tax_incl'] = $price_tax_incl;
        ...
        if ($context->cookie->__get('tvcmscompare_product_2') != '') {
            ...
            $price_tax_incl = Product::getPriceStatic($context->cookie->__get('tvcmscompare_product_2'), true, null, 3, null, false, true, 1, false, null, null, null, $specific_price_output, true, true, null, true);
            $prod_info_2['price_tax_incl'] = $price_tax_incl;
        ...
        if ($context->cookie->__get('tvcmscompare_product_3') != '') {
            ...
            $price_tax_incl = Product::getPriceStatic($context->cookie->__get('tvcmscompare_product_3'), true, null, 3, null, false, true, 1, false, null, null, null, $specific_price_output, true, true, null, true);
            $prod_info_3['price_tax_incl'] = $price_tax_incl;
        ...
        if ($context->cookie->__get('tvcmscompare_product_4') != '') {
            ...
            $price_tax_incl = Product::getPriceStatic($context->cookie->__get('tvcmscompare_product_4'), true, null, 3, null, false, true, 1, false, null, null, null, $specific_price_output, true, true, null, true);
            $prod_info_4['price_tax_incl'] = $price_tax_incl;
