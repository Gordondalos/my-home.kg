            ...
            <tr>
                ...
                <td class="tvcmscomparison tvcms-compare-product-{$prod_1.prod->id}">
                    ...
                    <div class="product-description">
                        ...
                        <div class="product-price-and-shipping">
                            <span itemprop="price" class="price cancle">{$prod_1.prod_price} </span>
                        ...
                        </div>{*<div class="tv-button-container">
                ...
                <td class="tvcmscomparison tvcms-compare-product-{$prod_2.prod->id}">
                    ...
                    <div class="product-description">
                        ...
                        <div class="product-price-and-shipping">
                            <span itemprop="price" class="price cancle">{$prod_2.prod_price} </span>
                ...
                <td class="tvcmscomparison tvcms-compare-product-{$prod_3.prod->id}">
                    ...
                    <div class="product-description">
                        ...
                        <div class="product-price-and-shipping">
                            <span itemprop="price" class="price cancle">{$prod_3.prod_price} </span>
                ...
                <td class="tvcmscomparison tvcms-compare-product-{$prod_4.prod->id}">
                    ...
                    <div class="product-description">
                        ...
                        <div class="product-price-and-shipping">
                            <span itemprop="price" class="price cancle">{$prod_4.prod_price} </span>
