    ...
    *}
    ...
    <div class="tvcompare-wrapper product_id_{$product.id_product}">
        <div class="product_id_{$product.id_product}">
            <button class="btn btn-unstyle tvcmsproduct-compare-btn" data-product-id='{$product.id_product}' data-comp-val='{if $prod_1 == $product.id_product || $prod_2 == $product.id_product || $prod_3 == $product.id_product || $prod_4 == $product.id_product}remove{else}add{/if}' data-toggle="tvtooltip" data-placement="top" data-html="true" data-original-title="Add to Wishlist" title="{l s='Compare' mod='tvcmsproductcompare'}">
                <div class="tvcmsproduct-compare-wrapper-icon">
                    <svg class='remove {if $prod_1 == $product.id_product || $prod_2 == $product.id_product || $prod_3 == $product.id_product || $prod_4 == $product.id_product}{else}hide{/if}' xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" focusable="false" width="15" height="15" style="-ms-transform: rotate(360deg); -webkit-transform: rotate(360deg); transform: rotate(360deg);" preserveAspectRatio="xMidYMid meet" viewBox="0 0 1024 1024">
                        <path d="M512 0q212 0 362 150t150 362t-150 362t-362 150t-362-150T0 512t150-362T512 0zm0 961q185 0 316.5-132T960 512T828.5 195.5T512 64T195.5 195.5T64 512t131.5 317T512 961zm-35-417H288q-14 0-23-9t-9-23t9-23t23-9h448q14 0 23 9t9 23t-9 23t-23 9H477z" fill="#222222"></path>
                    ...
                    <svg class='add {if $prod_1 == $product.id_product || $prod_2 == $product.id_product || $prod_3 == $product.id_product || $prod_4 == $product.id_product}hide{/if}' version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="15px" height="15px" viewBox="174.229 353.886 115.2 124.8" style="enable-background:new 174.229 353.886 115.2 124.8;" xml:space="preserve">
                        <g>
                ...
                <span>{l s='Compare This Product' mod='tvcmsproductcompare'}</span>
            </button>
        </div>
    </div>
    {/strip}