                        ...
                        <div class="blog_post_content_top">
                            <div class="post_thumbnail">
                                ...
                                <div class="tvnews-event-hoverbtn ">
                                    <picture>
                                        <source srcset="{$tvcmsblgpst.post_img_medium_res}" media="(max-width:768px)">
                                        <img class="img-responsive tvblog-balance-height" src="{$tvcmsblgpst.post_img_medium}" alt="{$tvcmsblgpst.post_title}">
                                    </picture>
                            ...
                            <div class="post-meta clearfix">
                                ...
                                <div class="tvblog-date-username">
                                    <div class="date_time tvdate-time">
                                        {* <span class="tvdate-time-icon"></span> *}{$tvcmsblgpst.post_date|date_format:'<p class="day_time tvday-time"><span>%d</span></p><p class="tvmonth-time"><span>%b</span></p>,<p class="tvyear-time"><span>%Y</span></p>' nofilter} 
                                    </div>
                                </div>
