...
<div class="comments_area" id="comments">
    ...
    <div class="comments_title">
        {l s='All comments' mod='tvcmsblog'}
    </div>
    {/if}
        ...
        <li class="comment" id="comment_{$tvcmsblog_commet.id_tvcms_comments}">
            <article class="comment_body clearfix">
				<div class="comment_author vcard">
				    <img alt="" class="tvcmsblog_img avatar avatar-70 photo" height="70" src="http://2.gravatar.com/avatar/597a1e6b0dfdf57f53ef8fb80fa190d7?s=70&d=mm&r=g" width="70">
				</div>
					...
					<div class="comment_meta">
					    ...
					    <div class="comment_meta_date">
					    	<time datetime="2016-03-07T04:33:23+00:00">
					    	    {$tvcmsblog_commet.created|date_format:"%e %B, %Y"}
					    	</time>
					    </div>
					    {* <div class="reply">
