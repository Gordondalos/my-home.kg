				...
				<div class="blog_post_content">
					<div class="blog_post_content_top col-xl-5 col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="post_thumbnail">
							...
							{else}
							<picture>
                                <source srcset="{$tvcmsblogpost.post_img_large_res}" media="(max-width:768px)">
                                <img class="tvcmsblog_img img-responsive" src="{$tvcmsblogpost.post_img_large}" alt="{$tvcmsblogpost.post_title}">
                            </picture>
							{/if}
						</div>
					</div>
