...
class TvcmsBlog extends Module
{
    ...
    public function __construct()
    {
        ...
        parent::__construct();
        $this->displayName = $this->l('HRXTemplate - Blog');
    ...
    public function addQuickAccessLink()
    {
        ...
        if (isset($languages) && !empty($languages)) {
            foreach ($languages as $language) {
                $QuickAccess->name[$language['id_lang']] = $this->l("HRXTemplate Settings");
            }
        }
    ...
    public function registerETabs()
    {
        ...
        foreach ($langs as $l) {
            $tabpar_listobj->name[$l['id_lang']] = $this->l("HRXTemplate Blog");
        }
    ...
    {
        $status_blog_all = (int)Configuration::get(TvcmsBlog::$tvcmsblogshortname."status_blog_all");
        $this->context->smarty->assign('status_blog_all', $status_blog_all);
