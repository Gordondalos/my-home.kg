...
* @author PrestaShop SA <contact@prestashop.com>
    ...
    *}
    ...
    <div class="tvtab-product-wrapper container wow fadeInUp">
                    ...
                    <div class="tvtab-title-wrapper">
                        <div class="tvtab-title">
                            <ul class="tvtabs-products">
                                ...
                                <li class="tvtab-name tab-index {if $tmp}active{/if}" data-tab-data='{$data.tab_name_id}' data-tab-paging='{$data.tab_name_class_pagination}' data-tab-data-slider-class='{$data.tab_name_class_slider}'><span>{$data.tab_name}</span></li>
                                {$tmp = false}
                                {/foreach}
                            </ul>
                        </div>
                ...
                <div class="tvall-product-branner tvall-product-branner-left col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                    <div class="tvall-block-box-shadows">
                        <div class="tvbanner-hover-wrapper">
                            ...
                            <img src="{$dis_arr_result.path}{$main_heading.data.image}" alt="{l s='Tab Product' mod='tvcmstabproducts'}" width="{$main_heading.data.width}" height="{$main_heading.data.height}">
