...
class TvcmsVerticalMenuClass extends ObjectModel
{
    ...
    public static $definition = array(
        ...
        'fields' => array(
            ...
            'style' => array('type' => self::TYPE_STRING, 'lang' => true, 'validate' => 'isCleanHtml'),
            'position' => array(
                'type' => self::TYPE_INT,
                'shop' => true,
                'validate' => 'isunsignedInt',
    ...
    public function __construct(
        ...
        Shop::addTableAssociation('tvcmsverticalmenu', array('type' => 'shop'));
        Shop::addTableAssociation('tvcmsverticalmenu_lang', array('type' => 'fk_shop'));
        if ($this->id) {
