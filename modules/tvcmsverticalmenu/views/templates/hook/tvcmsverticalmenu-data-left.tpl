...
* @author PrestaShop SA <contact@prestashop.com>
    ...
    *}
    ...
    <div class="tvcmsvertical-menu-wrapper-data wow fadeInUp">
                            ...
                            <li class="level-1 {$menu.class|escape:'htmlall':'UTF-8'} {if count($menu.sub_menu) > 0} parent{/if}">
                                <div class='tv-vertical-menu-text-wrapper'>
                                    ...
                                    <div class="tvvertical-menu-img-block">
                                        <img class="img-icon" src="{$icon_path|escape:'htmlall':'UTF-8'}{$menu.icon|escape:'htmlall':'UTF-8'}" alt="" />
                                        {$class = ''}
                                    </div>
                                                    ...
                                                    <div class="product-container clearfix">
                                                        <div class="product-image-container">
                                                            <a class="product_img_link" href="{$product.link|escape:'htmlall':'UTF-8'}" title="{$product.name|escape:'htmlall':'UTF-8'}">
                                                                <img class="img-responsive lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="{$link->getImageLink($product.link_rewrite, $product.id_image, 'home_default')|escape:'htmlall':'UTF-8'}" alt="{if !empty($product.legend)}{$product.legend|escape:'htmlall':'UTF-8'}{else}{$product.name|escape:'htmlall':'UTF-8'}{/if}" title="{if !empty($product.legend)}{$product.legend|escape:'htmlall':'UTF-8'}{else}{$product.name|escape:'htmlall':'UTF-8'}{/if}" />
                                                            </a>
