...
* @author PrestaShop SA <contact@prestashop.com>
    ...
    *}
    ...
    <div class='tvnew-product-wrapper-box container wow fadeInUp'>
        ...
        <div class='tvall-product-offer-banner '>
            ...
            <div class="tvall-product-branner tvall-product-branner-left col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                <div class="tvbanner-hover-wrapper tvall-block-box-shadows">
                    ...
                    <img src="{$dis_arr_result.path}{$main_heading.data.image}" alt="{l s='new Offer Banner' mod='tvcmsnewproducts'}" width="{$main_heading.data.width}" height="{$main_heading.data.height}">
