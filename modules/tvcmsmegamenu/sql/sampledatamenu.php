...
class SampleDataMenu
{
    public function initData()
    {
        ...
        $return &= Db::getInstance()->Execute('INSERT IGNORE INTO 
                ...
                (`id_tvcmsmegamenu`, `type_link`, `dropdown`, `type_icon`, `icon`,`background_img`,'
                .'`align_sub`, `width_sub`, '
                    .'`class`,`position`, `active`) VALUES 
        (1, 0, 0, 0,"", "", "", "tv-sub-auto", "", "", 1),
        (2, 0, 1, 0,"", "", "", "tv-sub-auto", "", "", 1),
        (3, 0, 0, 0,"", "", "", "tv-sub-auto", "", "", 1),
        (4, 0, 0, 0,"", "", "", "tv-sub-right", "", "", 1),
        (5, 0, 0, 0,"", "", "", "tv-sub-auto", "", "", 1);');
        ...
        $return &= Db::getInstance()->Execute('INSERT IGNORE INTO 
            ...
            .'`background_img`, `align_sub`, '
                .'`width_sub`, `class`,`position`, `active`) VALUES 
        (1, '.$id_shop.', 0, 0, 0, "","", "", "tv-sub-auto", "", "", 1),
        (2, '.$id_shop.', 0, 1, 0, "", "","", "tv-sub-auto", "", "", 1),
        (3, '.$id_shop.', 0, 0, 0, "", "","" ,"tv-sub-auto", "", "", 1),
        (4, '.$id_shop.', 0, 0, 0, "", "","", "tv-sub-right", "", "", 1),
        (5, '.$id_shop.', 0, 0, 0, "", "","", "tv-sub-auto", "", "", 1);');
        ...
        foreach ($languages as $language) {
            ...
            (2,'.$id_shop.','.$language['id_lang'].',"CAT3","CAT3","pro", ""),
            ...
            (6,'.$id_shop.','.$language['id_lang'].',"CAT5","CAT5",""),
            ...
            (19,'.$id_shop.','.$language['id_lang'].',"CAT5","CAT5",""),
