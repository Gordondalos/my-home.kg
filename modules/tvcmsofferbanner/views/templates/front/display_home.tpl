...
* @author PrestaShop SA <contact@prestashop.com>
    ...
    *}
    {strip}
    <div class="tvcmsofferbanners-one container-fluid wow fadeInUp">
        <div class="container">
            <a href="{$data['TVCMSOFFERBANNER_LINK']}" class="tvbanner-hover-wrapper" {* title="{$data['TVCMSOFFERBANNER_CAPTION'][$language_id]}" *}>
                <img src="{$path}{$data['TVCMSOFFERBANNER_IMAGE_NAME']}" class="tvimage-lazy img-responsive" alt="{l s='Offer Banner' mod='tvcmsofferbanner'}" height="{$data['TVCMSOFFERBANNER_IMAGE_HEIGHT']}" width="{$data['TVCMSOFFERBANNER_IMAGE_WIDTH']}" />
